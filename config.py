...
#Untuk daerah sudah dicover sama file kategori kecamatan nantinya, confignya dari file daerah aja. Cuma karena
#data yang ada sekarang belom kategori kecamatan, pake yang sejuk hangat aja sementara.
